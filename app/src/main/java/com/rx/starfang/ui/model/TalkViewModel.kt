...
class TalkViewModel(private val talkRepo: TalkRepository, private val rokRepo: RokRepository, private val memoRepo: MemoRepository): ViewModel() {
...
class TalkViewModelFactory(private val talkRepo: TalkRepository, private val rokRepo: RokRepository, private val memoRepo: MemoRepository): ViewModelProvider.Factory{
